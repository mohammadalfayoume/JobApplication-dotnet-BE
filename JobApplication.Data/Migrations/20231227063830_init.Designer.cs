            ...
            modelBuilder.Entity("JobApplication.Entity.Entities.CompanyProfile", b =>
                {
                    b.HasOne("JobApplication.Entity.Lookups.CityLookup", "City")
                        .WithOne()
                        .HasForeignKey("JobApplication.Entity.Entities.CompanyProfile", "CityId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobApplication.Entity.Lookups.CountryLookup", "Country")
                        .WithOne()
                        .HasForeignKey("JobApplication.Entity.Entities.CompanyProfile", "CountryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobApplication.Entity.Entities.JobSeekerProfile", b =>
                {
                    b.HasOne("JobApplication.Entity.Lookups.CityLookup", "City")
                        .WithOne()
                        .HasForeignKey("JobApplication.Entity.Entities.JobSeekerProfile", "CityId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("JobApplication.Entity.Lookups.CountryLookup", "Country")
                        .WithOne()
                        .HasForeignKey("JobApplication.Entity.Entities.JobSeekerProfile", "CountryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
